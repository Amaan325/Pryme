          ...
          <div className="bg-white flex-1 p-6 md:p-8 rounded-lg shadow-md">
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-6">
              <div>
                ...
                <input
                  type="text"
                  className="w-full border-0 border-b-4 border-gray-300 focus:border-blue-600 focus:outline-none px-0 py-2"
                  placeholder="John"
                />
              </div>
            ...
            <div className="mb-6">
              ...
              <textarea
                className="w-full border-0 border-b-4 border-gray-300 focus:border-blue-600 focus:outline-none px-0 py-2 h-32"
