    ...
    <>
      ...
      <div className="min-h-screen bg-white px-4 sm:px-8 py-10">
        <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <input
                ...
                className="border rounded-md p-3 w-full border border-gray-200"
              />
              <input
                type="text"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
              <div className="relative">
                ...
                <input
                  type="text"
                  className="border rounded-md p-3 w-full pl-14 bg-gray-100 text-gray-500 border border-gray-200"
                  disabled
                />
              </div>
          ...
          {/* Right Service Card */}
          <div className="bg-blue-50 rounded-xl shadow ">
            <img
              src={Service7}
            ...
            <div className="mt-4">
              ...
              <button className="text-sm text-black mt-4 hover:underline flex items-center gap-1 pl-24">
